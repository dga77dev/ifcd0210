...
public class ConvertidorController {
    ...
    // Se utilizan los datos de la vista y del modelo para obtener los datos del usuario
    public void convertirUnidades(){
        String unidadInicial = vista.leerUnidad("Tipo de unidad de medida inicial (cm/in):");


        String unidadFinal = vista.leerUnidad("Tipo de unidad de medida a convertir (cm/in):");
