...
SELECT c.nombre_cliente, SUM(IFNULL(p.total, 0)) AS total_pagado
FROM cliente c
...
SELECT c.nombre_cliente, e.nombre AS nombre_rep_ventas, e.apellido1 AS apellido1_rep_ventas, o.telefono AS telefono_oficina
FROM cliente c
...
SELECT c.nombre_cliente, e.nombre AS nombre_rep_ventas, e.apellido1 AS apellido1_rep_ventas, o.ciudad AS ciudad_oficina
FROM cliente c
JOIN empleado e ON c.codigo_empleado_rep_ventas = e.codigo_empleado
JOIN oficina o ON e.codigo_oficina = o.codigo_oficina;
